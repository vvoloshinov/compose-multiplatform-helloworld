...
public class RootProjectAccessor extends TypeSafeProjectDependencyFactory {
     ...
     */
    public ComposeMultiPlatformHelloWorldProjectDependency getComposeMultiPlatformHelloWorld() { return new ComposeMultiPlatformHelloWorldProjectDependency(getFactory(), create(":")); }
